import dbi # import the dbi script so the function is available
...
dbi.dbi(db,1,"generating a random number...","!EXEC!:demo_tools.RNG()","random number generated!: ","!EXEC!:demo_tools.printVar()")
